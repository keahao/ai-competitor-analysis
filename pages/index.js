...
export default function Home() {
  return (
    <Layout 
      ...
      description="深入了解您的竞争对手"
    >
      {/* Hero区域 */}
      <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl shadow-xl p-10 mb-12">
        <div className="text-center mb-10">
          <div className="text-6xl mb-4">🔍</div>
          <h2 className="text-4xl font-bold text-gray-800 mb-4">深入了解您的竞争对手</h2>
          <p className="text-xl text-gray-600 mb-6">对比表格、优势分析、战略建议</p>
          <div className="inline-block px-6 py-2 bg-white rounded-full shadow-md">
            <span className="text-orange-600 font-semibold">7天免费试用 · 无需信用卡</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition transform hover:-translate-y-1">
          ...
          <p className="text-gray-600">基于AI大模型，由市场分析师提供支持，生成高质量专业内容</p>
        </div>
